...
//Divide function into 2: for users and for admin
//Add log-in register function 
//Edit and convert it
...
system("read");//To hold data on screen
...
case '1'://Insert data
{ 
ofstream t1("teacher.txt",ios::app);        //ios::app = appending data to end-of-file
...
cout<<endl;
int notFound = 0;
for( j=0;((j<i)||(!t2.eof()));j++)      //eof(end-of-file) 
{ 
